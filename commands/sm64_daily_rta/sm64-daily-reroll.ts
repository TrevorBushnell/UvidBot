...
import { selectNewDailyStar, selectNewDaily100Star, announceDailyStars } from '../../utils/sm64_daily_rta';

module.exports = {
    data: new SlashCommandBuilder()
        .setName('sm64-daily-reroll')
        .setDescription('Reroll the current SM64 daily star (Authorized users only)'),
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        await interaction.reply({ content: '🔄 Rerolling daily star...', ephemeral: true });
